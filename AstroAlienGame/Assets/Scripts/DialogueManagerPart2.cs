...
public class DialogueManagerPart2 : MonoBehaviour
{
        ...
        private void Update()
    {
        ...
        {
            // If the panel was ALREADY open before we pressed E
            if (dialoguePanel.activeInHierarchy && index < dialogue.Length)
            {
                NextLine();
            }
        }
    ...
    public void NextLine()
    {
        ...
        else
        {
            ...
            QuestManager.Instance.MarkSeen("BlueAlienConvo");
    ...
    public void Begin()
    {
        ...
        var introEntry = database.GetDialogue("BlueAlienConvo");
